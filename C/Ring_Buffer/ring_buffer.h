...
typedef struct {
	...
	char *dataBuffer;
	uint32_t increment; // tell me about how much data is in the buffer. initialized = 0 in RingBuffer_Init();
	uint32_t FirstData; // tells on which position first valid data is.
} RingBuffer;
